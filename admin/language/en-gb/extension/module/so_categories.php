...
$_['heading_title_so']    = 'So Categories <b style="font-size:10px; background:#aaa; color:#fff; padding: 3px;font-weight:normal">version 2.2.0</b>';
...
$_['entry_placeholder_path_desc']      	= 'The Path (or URL) of Default Image. Eg: catalog/logo.png';
//Tabs Advanced 
