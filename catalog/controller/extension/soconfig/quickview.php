...
class ControllerExtensionSoconfigQuickview extends Controller {
	...
	public function index() {
		...
		if ($product_info) {
			...
			$full_description = html_entity_decode($full_description, ENT_QUOTES, 'UTF-8');
			$product_description_short = (strlen($full_description) > $limit ? utf8_substr($full_description, 0, $limit) . '...' : $full_description);
			if (isset($product_description_short)) $data['description_short']  = strip_tags($product_description_short);
