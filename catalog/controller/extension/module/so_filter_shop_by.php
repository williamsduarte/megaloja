...
class ControllerExtensionModuleSofiltershopby extends Controller {
	...
	public function filter_data(){
		...
		$product_data = $this->model_extension_module_so_filter_shop_by->getProducts($opt_value_id,$att_value_id,$manu_value_id,$text_search,$minPrice,$maxPrice,$subcate_value_id,$category_id,$condition_search);
